...
captures:
  ...
  - #2: First three scenes are edited in various ways. Mostly expanding implications. Using sentence fragments. Updating punctuation to match the original. Changing multiple predicates with sina/mi to use repeated li. & less use of kama (jo)
    - https://web.archive.org/web/20061210162148/http://tokipona.esperanto-jeunes.org:80/text/mphg.html
...
mi mute li tawa <Change from={2}>mute lon</Change> ma <Change till={2}>Kamela</Change> li wile e ni: jan utala <Change till={2}>pona</Change> li <Change till={2}>kama</Change><Change from={2}>wile lon kulupu Kamela mi</Change>.  

I must speak with your lord and master.  
mi wile toki tawa jan lawa sina.  

GUARD #1: What, ridden on a horse?  
jan utala pi nanpa wan: sina kama<Change till={2}> ala kama</Change> kepeken soweli<Change till={2}>?</Change><Change from={2}>. a.</Change>  
...
jan utala pi nanpa wan: <Change till={2}>kili ni li</Change><Change from={2}>sina lukin e ona</Change> lon ma Mesija? kili ni li awen lon ma seli<Change till={2}>.</Change><Change from={2}>!</Change>  
...
o tawa jan lawa sina. o toki e ni tawa <Change till={2}>sina</Change><Change from={2}>ona</Change>: jan Asa <Change from={2}>pi kulupu Kamela</Change> li lon.  
...
jan utala pi nanpa wan: <Change from={2}>a.</Change> waso pi ma Apika li ken tawa e ona. <Change from={2}>taso</Change> waso pi ma Elopa li ken ala.  

GUARD #2: Oh, yeah, I agree with that...  
jan utala pi nanpa tu: a. sina toki e lon...  

ARTHUR: Will you ask your master if he wants to join my court at Camelot?!  
jan Asa: o toki tawa jan lawa sina! <Change from={2}>ken la ona li wile lon kulupu Kamela mi.</Change>  

GUARD #1: But then of course African swallows are not migratory.  
jan utala pi nanpa wan: <Change from={2}>taso</Change> waso pi ma Apika li tawa ala ma ante.  
...
jan utala pi nanpa wan: <Change till={2}>ona li ken awen e ona kepeken luka</Change><Change from={2}>sina pilin ala pilin ante?</Change>.  
